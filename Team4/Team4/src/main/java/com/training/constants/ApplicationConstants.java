...
public class ApplicationConstants {
    ...
    public static final String errorMessageForLengthTasks = "Title is longer than 250 characters";
    public static final String errorMessageForMandatoryFieldNameTasks ="The field Title is required.";
}
